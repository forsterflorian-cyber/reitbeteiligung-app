...
export default async function SuchenPage({ searchParams }: SuchenPageProps) {
  ...
  return (
    <AppPageShell>
      ...
      {invalidPlzFilter ? <Notice text="Bitte gib für die Suche eine 5-stellige PLZ ein." tone="error" /> : null}
      ...
      <SectionCard subtitle="Die Umkreissuche arbeitet aktuell als leichter PLZ-Bereichsfilter, bis echte Distanzdaten verfügbar sind." title="PLZ-Umkreissuche">
                  ...
                  <div className="space-y-4">
                    ...
                    {nextTrialSlot ? (
                      <div className="rounded-2xl border border-stone-200 bg-stone-50/80 p-4">
                        <p className="text-sm font-semibold text-stone-900">Nächster Probetermin</p>
