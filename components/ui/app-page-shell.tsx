...
export function AppPageShell({ children, className, contentClassName }: AppPageShellProps) {
  return (
    <div className={cx("relative isolate overflow-hidden rounded-[2rem] border border-stone-200/80 bg-stone-50/72 p-3 shadow-sm backdrop-blur-[1px] sm:p-4", className)}>
      <Backdrop className="!inset-x-0 !top-8 !bottom-0" variant="section" />
      ...
      <div className="pointer-events-none absolute left-0 top-10 h-32 w-32 rounded-full bg-clay/8 blur-3xl" />
