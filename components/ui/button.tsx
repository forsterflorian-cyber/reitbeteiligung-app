...
const baseClassName =
  "inline-flex min-h-[44px] items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-forest/20 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60";

const variantClassNames: Record<ButtonVariant, string> = {
  primary: "bg-forest text-white shadow-sm hover:bg-forest/90",
  secondary: "border border-stone-300 bg-white text-stone-900 shadow-sm hover:border-forest hover:text-forest",
